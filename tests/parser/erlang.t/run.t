  ...
  module Function_declaration =
    struct
      ...
      let rec tuple_filled =
        function | () -> (`ok, (`error, "hello", 1), (tuple_empty ()))
      let rec list_empty = function | () -> []
      let rec list_nested = function | () -> [[]; [[]]]
      let rec list_filled =
        function | () -> [`ok; [`error; "hello"; 1]; list_empty ()]
      let rec list_cons =
        function | () -> [`a; [(`b, `c); [list_empty (); []]]]
      ...
      let rec fun_args_tuple_filled =
        function | `ok (`error ("hello", 1)) -> `ok
      let rec fun_args_list_empty = function | [] -> `ok
      let rec fun_args_list_nested = function | []::([]::[])::[] -> `ok
      let rec fun_args_list_filled =
        function | `ok::(`error::"hello"::1::[])::[] -> `ok
      let rec fun_args_list_cons =
        function | `a::((`b `c)::(`f::[]::[])::[])::[] -> `ok
      ...
      let rec fun_args =
        function | (a, b, c, d, e, f, g, h, i) -> (a, b, c, d, e, f, g, h, i)
