  ...
  caramel: [DEBUG] ((Str_fun
                      ((fn_visibility Private) (fn_name (Id hello))
                        (fn_args ()) (fn_arity 0) (fn_body (Expr_var (Id joe)))
                        (fn_annot ()))))
  ...
  $ caramel parse --file test.caramel --dump-parsetree --debug
  caramel: [DEBUG] ((Str_fun
                      ((fn_visibility Public) (fn_name (Id hello)) (fn_args ())
                        (fn_arity 0) (fn_body (Expr_literal (Lit_atom joe)))
                        (fn_annot ()))))
  ...
  caramel: [DEBUG] ((Str_fun
                      ((fn_visibility Public) (fn_name (Id fst))
                        ...
                        (fn_arity 2) (fn_body (Expr_var (Id x))) (fn_annot ()))))
  ...
  caramel: [DEBUG] ((Str_fun
                      ((fn_visibility Public) (fn_name (Id snd))
                        ...
                        (fn_arity 2) (fn_body (Expr_var (Id y))) (fn_annot ()))))
  ...
  caramel: [DEBUG] ((Str_fun
                      ((fn_visibility Public) (fn_name (Id pair))
                        ...
                        (fn_arity 2)
                        (fn_body
                          (Expr_tuple ((Expr_var (Id x)) (Expr_var (Id y)))))
                        (fn_annot ()))))
  ...
  caramel: [DEBUG] ((Str_fun
                      ((fn_visibility Public) (fn_name (Id double_pair))
                        ...
                        (fn_body
                          (Expr_tuple
                            ((Expr_tuple ((Expr_var (Id x)) (Expr_var (Id x))))
                              (Expr_tuple
  ...
  caramel: [DEBUG] ((Str_fun
                      ((fn_visibility Public) (fn_name (Id fix))
                        ...
                        (fn_body
                          (Expr_call (Expr_var (Id fix)) ((Expr_var (Id n)))))
                        (fn_annot ()))))
