  ...
  caramel: [DEBUG] (Pub Macro (Id hello_joe) Parens_left Parens_right
                     Brace_left Quote Brace_left (Atom hello_joe) Brace_right
                     Brace_right Pub Fn (Id main) Parens_left (Id args)
                     Parens_right Brace_left (Id hello_joe) Parens_left
  ...
  caramel: [DEBUG] ((Str_macro
                      ((fn_visibility Public) (fn_name (Id (hello_joe)))
                        (fn_args ()) (fn_arity 0)
                        (fn_body
                          (Expr_quote ((Quasiquote ((Atom hello_joe))))))
                        (fn_annot ())))
                     (Str_fun
  ...
  caramel: [DEBUG] let rec main args = `hello_joe
  ...
  (Module (name Caramel.Main)
    (defs
      (((df_name (module_info 0))
        ...
        ((df_name (main 1))
          (df_body (Fun ((args (args)) (body (Literal (Lit_atom hello_joe)))))))))
