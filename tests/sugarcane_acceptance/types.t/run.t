  ...
  type_args.ml
  variants.ml
  $ caramel compile --sugarcane *.mli type_alias.ml type_args.ml record.ml fn.ml polymorphic_variants.ml variants.ml qualified_names.ml opaque_and_hidden.ml inductive.ml extensible_variant.ml abstract.ml
