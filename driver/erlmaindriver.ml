...
(*                               Caramel                                  *)
(*                                                                        *)
(*                   Leandro Ostera, Abstract Machines                    *)
(*                                                                        *)
...
let usage = "Usage: caramelc <options> <files>\nOptions are:"

module Options = Erl_main_args.Make_bytecomp_options (Erl_main_args.Default.Main)

let main argv ppf =
  Clflags.add_arguments __LOC__ Options.list;
  Clflags.add_arguments __LOC__
    ["-depend", Arg.Unit Makedepend.main_from_option,
     "<options> Compute dependencies (use 'caramelc -depend -help' for details)"];
  match
