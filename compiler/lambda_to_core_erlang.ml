...
let rec build_expr : Lambda.lambda -> Core_erlang.Ast.expr =
 fun lambda ->
  match lambda with
...
let build_fun_expr : Lambda.lambda -> Core_erlang.Ast.fun_expr =
 fun lambda ->
  match lambda with
 ...
 *)
let build_definition : Lambda.lambda -> Core_erlang.Ast.fun_def =
 fun lambda ->
  match lambda with
 ...
 *)
let build_definitions : Lambda.lambda -> Core_erlang.Ast.fun_def list =
 fun lambda ->
