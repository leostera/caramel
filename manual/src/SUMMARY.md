...
- [Guides](./guides/index.md)
  ...
  - [Calling Elixir code](./guides/elixir-ffi.md)
...
- [Reference](./ref/index.md)
  - [Caramel CLI](./ref/cli.md)
    - [`caramel compile`](./ref/cli/compile.md)
    - [`caramel fmt`](./ref/cli/fmt.md)
    - [`caramel sort-deps`](./ref/cli/sort-deps.md)
  - [Language Features](./ref/lang/index.md)
  - [Standard Library](./ref/stdlib/index.md)
    - [`Binary`](./ref/stdlib/binary.md)
    - [`Calendar`](./ref/stdlib/calendar.md)
    - [`Erlang`](./ref/stdlib/erlang.md)
    - [`Ets`](./ref/stdlib/ets.md)
    - [`Io`](./ref/stdlib/io.md)
    - [`Lists`](./ref/stdlib/lists.md)
    - [`Maps`](./ref/stdlib/maps.md)
    - [`Process`](./ref/stdlib/process.md)
    - [`Timer`](./ref/stdlib/timer.md)
  - [Typed OTP](./ref/otp/index.md)
